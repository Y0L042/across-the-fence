...
class an_inventory
{
	...
	class Controls
	{
		...
		CREATESLOT(slot_lau, 2104,2004, UIX_CR((10 + EQUIP_SLOT_WPN_COLS + 0.5)),UIY_CU((10-(EQUIP_SLOT_SEC_ROWS+0.5))),UIW(EQUIP_SLOT_LAU_COLS),UIH(EQUIP_SLOT_LAU_ROWS), UIW(0),UIH(0),UIW(EQUIP_SLOT_LAU_COLS),UIH(EQUIP_SLOT_LAU_ROWS));
