...
#define EQUIP_SLOT_WPN_COLS 4
#define EQUIP_SLOT_WPN_ROWS (EQUIP_SLOT_WPN_COLS / 2)
// Seconday (Handgun)
// #define EQUIP_SLOT_SEC_COLS 4
// #define EQUIP_SLOT_SEC_ROWS 2
#define EQUIP_SLOT_SEC_COLS 2
#define EQUIP_SLOT_SEC_ROWS (EQUIP_SLOT_SEC_COLS / 2)
// Uniform
// #define EQUIP_SLOT_UNI_COLS 4
// #define EQUIP_SLOT_UNI_ROWS 6
#define EQUIP_SLOT_UNI_COLS 2
#define EQUIP_SLOT_UNI_ROWS (EQUIP_SLOT_UNI_COLS * 1.5)
// Vest
// #define EQUIP_SLOT_VST_COLS 4
// #define EQUIP_SLOT_VST_ROWS 4
#define EQUIP_SLOT_VST_COLS 2
#define EQUIP_SLOT_VST_ROWS EQUIP_SLOT_VST_COLS
// Backup
// #define EQUIP_SLOT_BKP_COLS 4
// #define EQUIP_SLOT_BKP_ROWS 4
#define EQUIP_SLOT_BKP_COLS 2
#define EQUIP_SLOT_BKP_ROWS EQUIP_SLOT_BKP_COLS
// Helmet
// #define EQUIP_SLOT_HEL_COLS 3
// #define EQUIP_SLOT_HEL_ROWS 3
#define EQUIP_SLOT_HEL_COLS 2
#define EQUIP_SLOT_HEL_ROWS EQUIP_SLOT_HEL_COLS
